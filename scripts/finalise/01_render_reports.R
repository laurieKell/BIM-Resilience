...
# exist under Rmd/html/<name>_files/figure-html/ after an HTML knit.
#
# Usage (from the project root):
#   source("scripts/finalise/01_render_reports.R")
#   renderAll("html")                      # all four, HTML only
#   renderAll(c("html","pdf","docx"))      # all formats
#   renderAll("html", which = c("pel","iccat"))
#
# Or:  Rscript scripts/finalise/01_render_reports.R html pdf
#
