...
%
% Figures are copies of knitr PNGs from Rmd/html/*_files/figure-html/,
% staged under tex/figs/. Refresh them (all in R) with:
%   source("scripts/finalise/02_stage_figures.R"); stageFigures()
% =============================================================================
...
\begin{itemize}
  ...
  \item \textbf{Figures are regenerated from the R Markdown knits.}
        ...
        \texttt{tex/figs/} in R with
        \texttt{source("scripts/finalise/02\_stage\_figures.R"); stageFigures()},
